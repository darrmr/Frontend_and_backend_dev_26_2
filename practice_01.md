...
### Итог
Используя разные препроцессоры и, соответственно, разный синтаксис, скомпилировали итоговые .css файл. Сравнивая результат, можно увидеть, что результат получился идентичным.

# Практическое задание

Практическое задание недели 1 (Практики 1-2) приложено в Практическом занятии 2