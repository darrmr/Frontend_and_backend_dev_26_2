...
Необходимо доработать веб‑приложение для управления списком дел (или заметок), созданное в рамках предыдущих прктических занятий, добавив поддержку Web App Manifest. Требования:
